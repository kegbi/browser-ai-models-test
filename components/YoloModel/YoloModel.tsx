...
import { runModelUtils, yolo, yoloTransforms } from "@/utils";
import ndarray from "ndarray";
import ops from "ndarray-ops";

interface YoloModelProps {
  imageUrl: string;
...
export function YoloModel({ imageUrl, modelFilepath }: YoloModelProps) {
  return <h1>YOloModel</h1>;
}
